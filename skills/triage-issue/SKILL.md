...
name: triage-issue
description: >-
  Investigate a bug or issue, find its root cause, and create a GitHub issue
  with a TDD-based fix plan. Use when the user reports a bug, wants to triage
  a problem, or needs root cause analysis.
---
...
Create a GitHub issue using `gh issue create --label ralphai-standalone` with the template below. Do NOT ask the user to review before creating — just create it and share the URL.
...
Does the fix affect any documentation? Consider:

- **README**: Does this fix change setup, usage, or API surface documented in README files?
- **Inline API docs**: Do public API signatures need updated JSDoc/TSDoc?
