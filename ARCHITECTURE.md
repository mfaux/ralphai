...
The executor abstraction decouples agent process spawning from the runner loop. The runner calls `executor.spawn()` via a factory, enabling different execution strategies.
