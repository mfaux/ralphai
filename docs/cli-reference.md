...
| `gate.maxRejections`      | `2`                       | `RALPHAI_GATE_MAX_REJECTIONS`       | Max completion-gate rejections before force-accept (0 = never force-accept, mark stuck instead)                                                                                                                                                                                                                           |
| `gate.maxIterations`      | `0`                       | `RALPHAI_GATE_MAX_ITERATIONS`       | Max runner iterations before marking stuck (0 = unlimited). Independent of `maxStuck` which counts zero-progress iterations.                                                                                                                                                                                              |
| `gate.reviewMaxFiles`     | `25`                      | `RALPHAI_GATE_REVIEW_MAX_FILES`     | Max files to include in the review-pass prompt                                                                                                                                                                                                                                                                            |
| `gate.validators`         | `""`                      | `RALPHAI_GATE_VALIDATORS`           | Comma-separated validator commands (run at the completion gate after feedback passes; agent-invisible)                                                                                                                                                                                                                    |
...
| `issueInProgressLabel`    | `"in-progress"`           | `RALPHAI_ISSUE_IN_PROGRESS_LABEL`   | State label added when an issue is being worked on                                                                                                                                                                                                                                                                        |
| `issueDoneLabel`          | `"done"`                  | `RALPHAI_ISSUE_DONE_LABEL`          | State label added when work completes successfully                                                                                                                                                                                                                                                                        |
| `issueStuckLabel`         | `"stuck"`                 | `RALPHAI_ISSUE_STUCK_LABEL`         | State label added when the agent gets stuck on an issue                                                                                                                                                                                                                                                                   |
